...
const GettingStarted = () => (
  <Container>
    <Columns>
      <Columns.Column
        size={2}
        style={{ position: 'fixed', top: 52, bottom: 0 }}
        responsive={{ touch: { hide: { value: true } } }}
      >
        <Menu style={innerPadding}>
          <Menu.List
            title={<Trans id="getting started">Getting Started</Trans>}
          >
            <Menu.List.Item>
              <ScrollLink
      ...
      <Columns.Column desktop={{ offset: 3 }}>
        <div style={innerPadding}>
          ...
          <H subtitle size={3}>
            <Trans id="introduction description">
              This library aims to help you use the Bulma CSS Framework in your
              React project
            </Trans>
          </H>
          <hr />
          <ScrollElement name="instalation">
            ...
            <H subtitle size={4}>
              <Trans id="instalation description">
                The easiest way to install React Bulma Components its using npm.
              </Trans>
            </H>
            <Highlight
              style={{ borderRadius: 5 }}
            >{`npm install react-bulma-components`}</Highlight>
          </ScrollElement>
          <hr />
          <ScrollElement name="usage">
            ...
            <H subtitle size={4}>
              <Trans id="usage description">
                Currently there are two ways to use this library depending of
            ...
            <ScrollElement name="basic-instalation">
              ...
              <H subtitle size={5}>
                <Trans id="basic instalation subtitle">
                  This configuration will allow you to start fast with minimum
                  configuration but with less customization and no treeshaking
                  by default (will include all components)
                </Trans>
              </H>
              <p>
                <Trans id="basic instalation description">
                  After the instalation you need to include the already
                  transpiled bulma css, and you can start importing the
                  component you need from the basic folder.
                </Trans>
              </p>
              <Box paddingless>
                <CodeExample
