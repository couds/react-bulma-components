...
const features = [
  ...
  },
  {
    ...
    description: (
      <Trans id="light weight description">No external dependencies</Trans>
    ),
    icon: 'quill',
  },
  {
    ...
    description: (
      <Trans id="modular description">Include only the code you use</Trans>
    ),
    icon: 'modular',
  },
  {
    ...
    description: (
      <Trans id="responsive description">
        Made for <b>Mobile</b> first
      </Trans>
    ),
    icon: 'responsive',
  },
