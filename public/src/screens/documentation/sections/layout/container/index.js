...
const ContainerDoc = () => (
	<Container fluid>
		...
		<Heading subtitle size={4} renderAs="h4">A simple container to center your content horizontally</Heading>
		<Content>
			<p>
			The
			<code>Container</code>
			component can be used in any context, but mostly as a <strong>direct child </strong>
			of either:
			</p>
			<ul>
