...
describe('Button component', () => {
  ...
  it('Should render as a React element link with custom href', () => {
    const component = renderer.create(<Button renderAs={Link} href="http://google.com" hrefAttr="to" color="danger" >
        TEST
      </Button>,);
    expect(component.toJSON()).toMatchSnapshot();
  });
  it('Should throw a console.error if no hrefAttr is defined when renderAs different as A and href attr is defined', () => {
    ...
    renderer.create(<Button renderAs={Link} href="http://google.com" color="danger" >
        TEST
      </Button>,);
