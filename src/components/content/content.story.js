...
export const AdjustableContentSize = (args) => (
  <Content {...args} size={args.size === 'default' ? '' : args.size}>
    <h1>Hello World</h1>
    <p>
      Lorem ipsum
      <sup>
...
AdjustableContentSize.storyName = 'Adjustable size';
AdjustableContentSize.argTypes = {
  size: {
    control: {
      type: 'select',
...
export const CustomizeItemMarkers = () => (
  <Content>
